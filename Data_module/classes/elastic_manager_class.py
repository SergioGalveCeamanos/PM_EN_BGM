...
class elastic_manager:
     def __init__(self, host, device,user,pwd,s=100,ag_time=5):
     ...
     def connect(self):
        self.client = Elasticsearch(hosts=[self.host],scheme="https",http_auth=(self.user, self.password),timeout=self.timeout)
